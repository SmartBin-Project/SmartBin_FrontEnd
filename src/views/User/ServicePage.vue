      ...
      <div class="max-w-7xl mx-auto px-6 md:px-12">
        <div class="flex flex-col md:flex-row items-center justify-between gap-12 lg:gap-20">
          ...
          <div class="flex-1 relative animate-fade-in-right">
            <div class="absolute -top-10 -right-10 w-64 h-64 bg-[#e9f2e6] rounded-full filter blur-3xl opacity-60"></div>
            <div class="absolute -bottom-10 -left-10 w-48 h-48 bg-[#68a357]/10 rounded-full filter blur-3xl opacity-60"></div>

            <div class="relative z-10 flex justify-center">
              <div class="relative w-full max-w-[500px]">
                <img 
                  src="@/assets/images/image.png" 
                  alt="Smart Bin Technology Illustration" 
                  class="w-full h-auto drop-shadow-2xl object-contain"
                />
                
                <div class="absolute top-1/4 -left-4 w-4 h-4 bg-[#68a357] rounded-full animate-bounce"></div>
                <div class="absolute bottom-1/4 -right-4 w-3 h-3 bg-gray-200 rounded-full"></div>
              </div>
            </div>
          </div>
...
<style scoped>
/* Custom Animations remain the same */
...
h2 { letter-spacing: -0.02em; }
  ...
  <div class="service-page">
    ...
    <p class="text-lg text-gray-700">
      Welcome to our service page! Here you can find information about the various services we offer to help you manage your waste efficiently and sustainably.
    </p>
